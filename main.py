...
def sub():
    ...
    markup.row_width = 2
    markup.add(InlineKeyboardButton("JOIN CHANNEL 馃摙", url="https://t.me/pristbank"))
    return markup

def commands_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("MAIN MENU 馃敯", callback_data="menu"))
    return markup

def start_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("FREE TIPS 鉀戯笍", callback_data="free"),
               InlineKeyboardButton("VIP MATCHES 馃挴", callback_data="vip-menu"))
    return markup
...
def help_btn():
    ...
    markup.row_width = 2
    markup.add(InlineKeyboardButton("MAIN MENU 馃敯", callback_data="menu"),
               InlineKeyboardButton("CONTINUE 鉃★笍", callback_data="vip-menu"))
    return markup

def free_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("BACK 馃敊", callback_data="menu"),
               InlineKeyboardButton("TODAYS TIPS 鉀戯笍", callback_data="today's_tips"))
    return markup
...
def freetips_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("RELOAD TIP 馃攦", callback_data="reload"),
               InlineKeyboardButton("馃挴 SURE ODDS", callback_data="vip-menu"))
    return markup
def reload_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
...
def vipmenu_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("TODAY'S GAMES 鉁�", callback_data="vip"),
               InlineKeyboardButton("HOW IT WORKS 鈦夛笍", callback_data="how"))
    return markup

def how_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("JOIN VIP NOW 馃挵", callback_data="vip-menu"),
               InlineKeyboardButton("ASK MORE 馃さ", callback_data="admin"))
    return markup
#reply keyboard for admin
def admin_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("ADMIN 馃暣锔�", url='https://t.me/pristlegacy'))
    markup.add(InlineKeyboardButton("MAIN MENU 馃敯", callback_data="menu"))
    return markup
...
def htft_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("BACK 馃敊", callback_data="vip"))
    return markup

def cs_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("BUY MATCHES NOW 馃挵", callback_data="subscribe"))
    markup.add(InlineKeyboardButton("BACK 馃敊", callback_data="vip"),
               InlineKeyboardButton("MAIN MENU 馃敯", callback_data="menu"))
...
def country_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("UGANDA 馃嚭馃嚞", callback_data="ug"),
               InlineKeyboardButton("KENYA 馃嚢馃嚜", callback_data="ke"),
               InlineKeyboardButton("GHANA 馃嚞馃嚟", callback_data="gh"),
               InlineKeyboardButton("RWANDA 馃嚪馃嚰", callback_data="rw"),
               InlineKeyboardButton("TANZANIA 馃嚬馃嚳", callback_data="tz"),
               InlineKeyboardButton("USA 馃嚨馃嚪", callback_data="usa"),
               InlineKeyboardButton("NIGERIA 馃嚦馃嚞", callback_data="ng"))
    markup.add(InlineKeyboardButton("馃敊", callback_data="cs"), 
               InlineKeyboardButton("OTHERS 馃寪", callback_data="others"))
    return markup
...
def ug_btn():
    ...
    markup.add(InlineKeyboardButton("NOT SURE 鈦夛笍", callback_data="vip_des"))
    return markup
def ke_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
...
def others_btn():
    markup = InlineKeyboardMarkup()
    markup.row_width = 2
    markup.add(InlineKeyboardButton("BACK 馃敊", callback_data="country"),
